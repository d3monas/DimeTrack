...
export function SyncManager({ syncId, onEnableSync, onPullData, onPushData, isSyncing, lastSynced }: SyncManagerThings) {
    ...
    <div>
      ...
      {!syncId ? (
        ...
        <div className="space-y-4">
          ...
          <Button variant="outline" className="w-full" onClick={onPushData} disabled={isSyncing}>
